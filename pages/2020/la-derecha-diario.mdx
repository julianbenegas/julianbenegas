...
export default ({ children }) => <Layout pagetitle='La Derecha Diario' description="A digital newspaper that doesn't compromise on Truth." image="/event-photos/ldd/home.png">{children}</Layout>
...
<screenshot src="/event-photos/ldd/enter.png" caption="Sign in / sign up is a modal. Who wants to go to another page to sign in?" />
...
<screenshot src="/event-photos/ldd/admin.png" caption="Custom table component (that I'll reuse everywhere cause it was lots of work)" />
